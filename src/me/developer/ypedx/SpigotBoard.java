...
public class SpigotBoard extends JavaPlugin {
	...
	public void onEnable() {
		...
		if(getServer().getPluginManager().getPlugin("Vault") == null) {
			...
			getLogger().log(Level.INFO, "Vault not found, disabling support for balance.");
		...
		if(getServer().getPluginManager().getPlugin("PlaceholderAPI") == null) {
			...
			getLogger().log(Level.INFO, "PlaceholderAPI not found, disabling support for PlaceholderAPI.");
		}
		
		
		if(getServer().getPluginManager().getPlugin("Essentials") == null) {
			
			getLogger().log(Level.INFO, "Essentials not found, disabling support for balance.");
